...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.value_log_filename = QLabel(self.common_tab)
        self.value_log_filename.setObjectName(u"value_log_filename")
        self.value_log_filename.setGeometry(QRect(200, 160, 274, 30))
        ...
        self.exclude_dirs_list = QTableWidget(self.exclusions_tab)
        self.exclude_dirs_list.setObjectName(u"exclude_dirs_list")
        self.exclude_dirs_list.setGeometry(QRect(10, 250, 255, 345))
        self.exclude_dirs_list.setMidLineWidth(1)
        self.exclude_files_list = QTableWidget(self.exclusions_tab)
        self.exclude_files_list.setObjectName(u"exclude_files_list")
        self.exclude_files_list.setGeometry(QRect(280, 250, 250, 345))
        self.exclude_files_list.horizontalHeader().setStretchLastSection(True)
        ...
        self.exclude_cache_files.setObjectName(u"exclude_cache_files")
        ...
        self.include_files_list = QTableWidget(self.inclusions_tab)
        self.include_files_list.setObjectName(u"include_files_list")
        self.include_files_list.setGeometry(QRect(280, 100, 250, 345))
        self.include_dirs_list = QTableWidget(self.inclusions_tab)
        self.include_dirs_list.setObjectName(u"include_dirs_list")
        self.include_dirs_list.setGeometry(QRect(10, 100, 250, 345))
        self.include_dirs_list.setMidLineWidth(1)
...
#if QT_CONFIG(tooltip)
        self.value_log_filename.setToolTip("")
#endif // QT_CONFIG(tooltip)
        self.value_log_filename.setText("")
...
#endif // QT_CONFIG(tooltip)
        self.exclude_cache_files.setText(QCoreApplication.translate("Setup", u"Cache Files", None))
#if QT_CONFIG(tooltip)
