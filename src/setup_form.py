...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.include_previous_button.setEnabled(True)
        ...
        self.include_specific_files.setEnabled(True)
        ...
        self.include_specific_dirs.setEnabled(True)
