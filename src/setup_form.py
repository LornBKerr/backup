...
class Ui_Setup(object):
    def setupUi(self, Setup):
        ...
        self.start_dir_lbl.setObjectName("start_dir_lbl")
        ...
        self.last_backup_lbl.setObjectName("last_backup_lbl")
        self.last_backup_lbl.setGeometry(QRect(10, 330, 182, 30))
        self.last_backup_lbl.setAlignment(
        ...
        self.backup_llbl.setObjectName("backup_llbl")
        self.backup_llbl.setGeometry(QRect(10, 110, 161, 36))
        self.backup_llbl.setAlignment(
            Qt.AlignmentFlag.AlignLeading
            | Qt.AlignmentFlag.AlignLeft
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.backup_path_lbl.setObjectName("backup_path_lbl")
        self.backup_path_lbl.setGeometry(QRect(10, 180, 161, 36))
        self.backup_path_lbl.setAlignment(
            Qt.AlignmentFlag.AlignLeading
            | Qt.AlignmentFlag.AlignLeft
            | Qt.AlignmentFlag.AlignVCenter
        )
        ...
        self.backup_log_filename_lbl.setObjectName("backup_log_filename_lbl")
    ...
    def retranslateUi(self, Setup):
        ...
        self.backup_llbl.setText(
            QCoreApplication.translate("Setup", "Backup to:", None)
        )
        # if QT_CONFIG(tooltip)
        self.log_name.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.backup_path_lbl.setText(
            QCoreApplication.translate("Setup", "Backup Log Path:", None)
        )
        # if QT_CONFIG(tooltip)
        self.log_path.setToolTip("")
        # endif // QT_CONFIG(tooltip)
        self.backup_log_filename_lbl.setText(
            QCoreApplication.translate("Setup", "Backup Log Filename:", None)
        )
